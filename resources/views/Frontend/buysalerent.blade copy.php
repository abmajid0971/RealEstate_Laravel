                          ...
                          <div class="col-lg-4 col-sm-6">
                              ...
                              <p>e</p>
                                  <div class="image-holder">
                                    <img class="img-responsive" alt="properties" src="{{asset('uploads/'.$varpr->P_image)}}">
                                  ...
                                  <div class="listing-detail">
                                      <span data-toggle="tooltip" data-placement="bottom"
                                          data-original-title="Bed Room">{{$varpr->Bed}}</span> <span
                                          data-toggle="tooltip" data-placement="bottom"
                                          data-original-title="Living Room">{{$varpr->LivingRoom}}</span> <span
                                          data-toggle="tooltip" data-placement="bottom"
                                          data-original-title="Parking">{{$varpr->Parking}}</span> <span
                                          data-toggle="tooltip" data-placement="bottom"
                                          data-original-title="Kitchen">{{$varpr->Kitchen}}</span>
                                  </div>
