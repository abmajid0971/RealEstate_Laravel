...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="{{asset('uploads/'.$varpr->P_image)}}" class="img-responsive img-circle" alt="properties"/></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="/propertydetail/{{$varpr->id}}">{{$pd->Title}}</a></h5>
                  <p class="price">{{$varpr->Price}}</p> </div>
              </div>
              @endforeach  
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="{{asset('uploads/'.$pd->P_image)}}" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->
...
<!-- #Slider Ends -->
  ...
  <div><h4><span class="glyphicon glyphicon-map-marker"></span>{{$pd->Location}}</h4>
...
<p class="price">{{$pd->Price}}</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span>{{$pd->Address}}</p>
