...
<!-- #Slider Ends -->
  ...
  <div><h4><span class="glyphicon glyphicon-map-marker"></span>{{$pro1->Location}}</h4>
...
<p class="price">{{$pro1->Price}}</p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span>{{$pro1->Address}}</p>
  
  <div class="profile">
  <span class="glyphicon glyphicon-user"></span> Agent Details
  <p>{{$pro1->Agent}}<br>{{$pro1->Agent}}</p>
  </div>
</div>

    <h6><span class="glyphicon glyphicon-home"></span> Availabilty</h6>
    <div class="listing-detail">
    <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room">{{$pro1->Bed}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Living Room">{{$pro1->LivingRoom}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">{{$pro1->Parking}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">{{$pro1->Kitchen}}</span> </div>
