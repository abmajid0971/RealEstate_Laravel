                ...
                <div class="col-lg-9 col-sm-8 ">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div>
                                <h4><span class="glyphicon glyphicon-map-marker"></span>{{$pro1->Location}}</h4>
                        ...
                        <div class="col-lg-4">
                            <div class="col-lg-12  col-sm-6">
                                <div class="property-info">
                                    ...
                                    <p class="area"><span
                                            class="glyphicon glyphicon-map-marker"></span>{{$pro1->Address}}</p>
                                ...
                                <div class="listing-detail">
                                    <span data-toggle="tooltip" data-placement="bottom"
                                        data-original-title="Bed Room">{{$pro1->Bed}}</span> <span data-toggle="tooltip"
                                        data-placement="bottom"
                                        data-original-title="Living Room">{{$pro1->LivingRoom}}</span> <span
                                        data-toggle="tooltip" data-placement="bottom"
                                        data-original-title="Parking">{{$pro1->Parking}}</span> <span
                                        data-toggle="tooltip" data-placement="bottom"
                                        data-original-title="Kitchen">{{$pro1->Kitchen}}</span>
                                </div>
